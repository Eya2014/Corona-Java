...
public class FrmGov extends javax.swing.JInternalFrame {

    ServiceGov srv = new ServiceGov();
    ...
    public void d_p() {
        ...
        lstGov.setVisible(false);
        ServicePays.model1.getDataVector().clear();
        lstGov.setModel(ServicePays.model1);
        lstGov.setVisible(true);
        java.util.List<String> list = srv.lstgovcombo();
    ...
    public FrmGov() {
        ...
        lstGov.setRowSelectionAllowed(true);
        lstGov.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
...
// TODO add your handling code her
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 74, -1, 20));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 40, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, 40, 30));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 40, 30));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 100, 40, 30));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 100, 40, 30));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 100, 40, 30));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 100, 40, 30));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 100, 40, 30));
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 100, 40, 30));
        ...
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 40, 30));
        ...
        getContentPane().add(jButton14, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, 40, 30));
        ...
        getContentPane().add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 40, 30));
        ...
        getContentPane().add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 100, 40, 30));
        ...
        getContentPane().add(jButton17, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 100, 40, 30));
        ...
        getContentPane().add(jButton18, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 100, 40, 30));
        ...
        getContentPane().add(jButton19, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 100, 40, 30));
        ...
        getContentPane().add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 100, 40, 30));
        ...
        getContentPane().add(jButton21, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 100, 40, 30));
        ...
        lstGov.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null},
                {null},
                {null},
        ...
        lstGov.setFocusable(false);
        jScrollPane2.setViewportView(lstGov);
        if (lstGov.getColumnModel().getColumnCount() > 0) {
            lstGov.getColumnModel().getColumn(0).setResizable(false);
        }

        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 190, 80));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, 230, 90));
        ...
        getContentPane().add(jButton23, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 30, 200, 50));
        ...
        getContentPane().add(com, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, 200, -1));
        ...
        getContentPane().add(b1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 60, 30, 30));
        ...
        getContentPane().add(b2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 60, 30, 30));
        ...
        getContentPane().add(b3, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 60, 30, 30));
        ...
        jButton25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-ascending-sorting-27.png"))); // NOI18N
        ...
        getContentPane().add(jButton25, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 100, 40, 30));

        jButton26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8-ascending-sorting-27 - Copie.png"))); // NOI18N
        ...
        getContentPane().add(jButton26, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 100, 40, 30));

        jMenu12.setText("Par Gouvernorat");
        ...
        bt_t_cas_d_p.setText("Par date et gouvernorat");
        ...
        bt_t_cas_p.setText("Par gouvernorat");
        ...
        bt_t_deces_d_p.setText("Par date et gouvernorat");
        ...
        bt_t_deces_p.setText("Par gouvernorat");
        ...
        bt_t_recup_d_p.setText("Par date et gouvernorat");
        ...
        bt_t_recup_p.setText("Par gouvernorat");
        ...
        bt_t_test_d_p.setText("Par date et gouvernorat");
        ...
        bt_t_test_p.setText("Par gouvernorat");
        ...
        bt_n_cas_d_p.setText("Par date et gouvernorat");
        ...
        bt_n_cas_p.setText("Par gouvernorat");
        ...
        bt_n_deces_d_p.setText("Par date et gouvernorat");
        ...
        bt_n_deces_p.setText("Par gouvernorat");
        ...
        bt_n_recup_d_p.setText("Par date et gouvernorat");
        ...
        bt_n_recup_p.setText("Par gouvernorat");
        ...
        bt_n_test_d_p.setText("Par date et gouvernorat");
        ...
        bt_n_test_p.setText("Par gouvernorat");
    ...
    public void AfficherDonnees(String d1, String d2, String Model) {
        ...
        switch (graph) {
               case "Gov":
                Chart = srv.Gov(com.getSelectedItem().toString());
                break;
            case "total_cas_d_p":
...
// TODO add your handling code here:
   ...
   jButton26.setVisible(false);
        jButton25.setVisible(true);        jTable1.setVisible(false);
...
// TODO add your handling code here:
   ...
   jButton26.setVisible(false);
        jButton25.setVisible(true);        jTable1.setVisible(false);
        jTable1.setModel(srv.mon_model_triée("nomgv", "desc"));
        jTable1.setVisible(true);
...
jButton26.setVisible(true);
        jButton25.setVisible(false);       jTable1.setVisible(false);
...
jButton26.setVisible(true);
        jButton25.setVisible(false);        jTable1.setVisible(false);
        jTable1.setModel(srv.mon_model_triée("nomgv", "asc"));
        jTable1.setVisible(true);
        jButton1.setVisible(false);
        jButton2.setVisible(true);
        jButton3.setVisible(false);
...
int i=0;
        ...
        if (lstGov.getRowCount() == 0 && (choix ==2|| choix ==1)) {
            i=1;
        ...
        if(i==0) {
           ...
           if(choix ==2|| choix ==1)
           { 
             DefaultTableModel modelx = (DefaultTableModel) lstGov.getModel();
             String selectedx = modelx.getValueAt(0, 0).toString();
               System.out.println("selected : " +selectedx);
                pys ="'" + selectedx + "'";
            for (int row = 1; row < lstGov.getRowCount(); row++) {
                DefaultTableModel model = (DefaultTableModel) lstGov.getModel();
                System.out.println("taille tab : " + lstGov.getRowCount());
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        int exist = 0;
        int rowCount = lstGov.getRowCount();
        System.out.println(rowCount);
        for (int row = 0; row < lstGov.getRowCount(); row++) {
            DefaultTableModel model = (DefaultTableModel) lstGov.getModel();
            String selected = model.getValueAt(row, 0).toString();
        ...
        if (exist == 0) {
            lstGov.setModel(srv.lstGov(text));
        } else {
            JOptionPane.showMessageDialog(this, "Vous avez deja choisis cette Gouvernorat.");
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_b1ActionPerformed

    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
  if(lstGov.getSelectedRow() != -1) {
               // remove selected row from the model
               lstGov.setVisible(false);
               ServicePays.model1.getDataVector().remove(lstGov.getSelectedRow());
               lstGov.setModel(ServicePays.model1);
               lstGov.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_b2ActionPerformed
    }
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed

        lstGov.setVisible(false);
        ServiceGov.model1.getDataVector().clear();
        lstGov.setModel(ServiceGov.model1);
        lstGov.setVisible(true);
...
// TODO add your handling code here:
    ...
    private javax.swing.JTable lstGov;
