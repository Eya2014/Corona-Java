...
public final class Principale extends javax.swing.JFrame {
    ...
    public void setConnected() {
        ...
        ImageIcon img = new ImageIcon("src/Image/power-off.png");
    ...
    public void setDisconnected() {
        ...
        ImageIcon img = new ImageIcon("src/Image/power-on.png");
        btnDisconnect.setIcon(new ImageIcon(img.getImage().getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH)));
    ...
    protected JToolBar createToolBar() {
        ...
        img = new ImageIcon("src/Image/monde.png");
        ...
        img = new ImageIcon("src/Image/tunisia.png");
        ...
        img = new ImageIcon("src/Image/hospital.png");
        ...
        img = new ImageIcon("src/Image/government.png");
        ...
        toolBar.add(btnpays);
        img = new ImageIcon("src/Image/pays.png");
        ...
        img = new ImageIcon("src/Image/about.png");
